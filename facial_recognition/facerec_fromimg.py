...
def main(datapath , fname , output_file="out.jpg"):
    
    print("reading faces data...")
    known_face_encodings,known_face_indexs , fd =  datafaces(datapath)
    ...
    # Find all the faces and face encodings in the img
